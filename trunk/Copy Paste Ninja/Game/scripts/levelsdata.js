...
var levelsData = [
        ...
        { // First level
            ...
            entities: [
                ...
                { type: "ground", name: "dirt", x: 5120/2, y: 600 - 15, width: 5120, height: 30, isStatic: true },
                { type: "ground", name: "dirt", x: 5120 / 2, y: 15, width: 1280, height: 30, isStatic: true },
                { type: "ground", name: "dirt", x: 15, y: 600 / 2, width: 30, height: 600, isStatic: true },
                { type: "ground", name: "dirt", x: 5120 - 15, y: 600 / 2, width: 30, height: 600, isStatic: true },

                // platforms
                { type: "block", name: "platform", x: 320, y: 420, width: 200, height: 30, isStatic: true },
                { type: "block", name: "platform", x: 580, y: 500, width: 200, height: 30, isStatic: true },
                { type: "block", name: "platform", x: 850, y: 420, width: 200, height: 30, isStatic: true },
                ...
                // code
                { type: "code", name: "code", x: 350, y: 350, width: 45, height: 30, isStatic: true, dead: false, score: 10 },
                { type: "code", name: "code", x: 150, y: 450, width: 45, height: 30, isStatic: true, dead: false, score: 10 },
                ...
                // hero
                { type: "hero", name: "ninja", x: 50, y: 500 },
                // { type: "hero", name: "badninja", x: 550, y: 410 },
                // { type: "hero", name: "nakov", x: 150, y: 510, minLeft: 100, maxRight: 400 },
                { type: "hero", name: "niki", x: 650, y: 410, minLeft: 750, maxRight: 1200 },
                { type: "hero", name: "doncho", x: 200, y: 510, minLeft: 120, maxRight: 500, chaseOffset: 50 },
            ]
        },
